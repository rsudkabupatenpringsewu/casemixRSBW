            ...
            <div class="card-body">
                <div class="card py-4  d-flex justify-content-center align-items-center">
                    ...
                    <div style="border: 1px solid #000;">
                        <table width="700px">
                            <tr>
                                <td class="text-center" style="background-color: rgb(236, 230, 197)"><h3>PENILAIAN AWAL MEDIS RAWAT INAP</h3></td>
                            </tr>
                        </table>
                        ...
                        <table  width="700px" style="border-top: 1px solid #000;">
                            <tr>
                                <td height="60px" style="vertical-align: top;">Keterangan : {{$awalMedis->ket_fisik}}</td>
                            </tr>
                        </table>
                        <table  width="700px" style="border-top: 1px solid #000;">
                            <tr>
                        ...
                        <table  width="700px" style="border-top: 1px solid #000;">
                            <tr height="50px">
                                ...
                                <td width="230px" style="vertical-align: top;">Laboratorium : {{$awalMedis->lab}}</td>
                            </tr>
                        </table>
                        <table  width="700px" style="border-top: 1px solid #000;">
                            <tr>
